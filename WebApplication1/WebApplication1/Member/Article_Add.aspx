<%@ Page Language="C#" MasterPageFile="~/Member/Member.Master" AutoEventWireup="true" CodeBehind="Article_Add.aspx.cs" Inherits="TotCms.Web.Member.Article_Add" ValidateRequest="false" %>
    ...
    <table cellpadding="0" cellspacing="0" style="width: 100%">
        ...
        <tr>
            <td valign="top">
                文章内容：</td>
            <td>
                <textarea name="Content">在此填写文章内容...</textarea>
